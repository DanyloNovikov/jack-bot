...
module Operations
  class Help < Operations::BaseOperation
    ...
    def text_for_message
      "search - the command is responsible for searching by various attributes such
as ingredients, name as well as searching for the description of ingredients
simply select search in the context menu or enter search.\n
